        ...
        <div id="expenses-container" class="container">
            ...
            <div id="left-container">
                ...
                <div id="expenses-summary">
                    <div>
                        <h2>Bienvenid@ <?php echo $user->getname()?></h2>
                    </div>
                        ...
                        <div class="card w-50">
                            <div class="total-budget">
                                <span class="total-budget-text">
                                    de
                                    $<?php
                                        echo number_format($user->getBudget(),2) . ' mensuales que te restan';
                                        ?>
                                </span>
                            </div>
                            <div class="total-expense">
...
<?php }
                      ...
                      <?php
                          if($expenses===NULL){
                            ...
                            <div class='preview-expense'>
                                ...
                                <div class='right'>
                                    <div class='expense-amount'>$<?php echo number_format($expense->getAmount);?></div>
                                </div>
                                <?php
                            }
                            echo '<div class="more-container"><a href="expenses">Ver todos los expenses</a></div>';
                          }
                                ?>
    ...
    <script src="../../gpublico/js/dashboard.js"></script>
